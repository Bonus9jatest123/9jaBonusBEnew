...
const Row = (props: Props) => {
  ...
  const handleDelete = () => {
    ...
    axios
      .delete(`${API_ENDPOINT}/offers/${selectedId}`, { headers })
      .then(() => {
  ...
  const infoAdded = data?.infoImage?.imageUrl || data?.upTo;
  return (
    <>
      <div className="row">
